...
describe('handler', () => {
    ...
    // Tests that a GET request with an invalid slug returns a 404 status code
    it('should return a 404 status code when a GET request with an invalid slug is made', async () => {
        const req = { method: 'GET', query: { slug: 'invalid-slug' } };
        const res = { status: jest.fn().mockReturnThis(), json: jest.fn() };
        Product.find = jest.fn().mockResolvedValue(null);
