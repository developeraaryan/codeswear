        ...
        <div className="flex">
          ...
          <div className="w-1/4">
            <div className="relative mb-2">
              ...
              <div className={`w-10 h-10 mx-auto ${status === "shipped" | status === "delivered" | status === "canceled" ? "bg-green-500" : "bg-white border"}  rounded-full text-lg text-white flex items-center`}>
          ...
          <div className="w-1/4">
            <div className="relative mb-2">
              ...
              <div className={`w-10 h-10 mx-auto ${status === "delivered" | status === "canceled" ? "bg-green-500" : "bg-white"}  border-2 border-gray-200 rounded-full text-lg text-white flex items-center`}>
          ...
          <div className="w-1/4">
            <div className="relative mb-2">
              ...
              <div className={`w-10 h-10 mx-auto ${status === "canceled" ? "bg-green-500" : "bg-white"} border-2 border-gray-200 rounded-full text-lg text-white flex items-center`}>
                <span className={`text-center ${status === "delivered" | status === "canceled" ? "text-white" : "text-black"}  w-full flex justify-center`}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
