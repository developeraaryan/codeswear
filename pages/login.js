      ...
      <section className="bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img className="w-8 h-8 mr-2" src="/codeswearciecle.png" alt="logo" />
            Codeswear
          </a>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={'/forgot'} className="text-sm font-medium text-pink-500 hover:text-pink-700 dark:text-pink-500"> Forgot password?</Link>
                </div>
                <button type="submit" className="w-full text-black bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800">Sign in</button>
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  Don’t have an account yet? <Link href={'/signup'} className="font-medium text-pink-500 hover:text-pink-700  dark:text-pink-500">Sign up</Link>
                </p>
                {/* <!-- Divider --> */}
                <div
                ...
                <a
                  ...
                  {/* <!-- Facebook --> */}
                  <BsFacebook className=' mx-3 text-xl' />
