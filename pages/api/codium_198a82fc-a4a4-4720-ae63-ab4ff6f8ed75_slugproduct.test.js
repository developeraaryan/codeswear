...
describe('handler', () => {
    ...
    // Tests that a GET request with a valid slug returns the correct product
    it('should return the correct product when a GET request with a valid slug is made', async () => {
        const req = { method: 'GET', query: { slug: 'valid-slug' } };
        const res = { status: jest.fn().mockReturnThis(), json: jest.fn() };
        const mockProduct = { _id: 'valid-id', slug: 'valid-slug', title: 'valid-title', category: 'valid-category', desc: 'valid-desc', size: ['valid-size'], price: 'valid-price', availableqty: 1, img: 'valid-img' };
