...
describe('handler', () => {
    ...
    // Tests that a GET request with a valid slug but no matching product returns a 404 status code
    it('should return a 404 status code when a GET request with a valid slug but no matching product is made', async () => {
